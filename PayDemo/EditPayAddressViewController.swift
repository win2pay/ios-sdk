...
class EditPayAddressViewController: UIViewController {
    ...
    @objc func toPay(){
        ...
        //地址信息
        let billAdress = WPBillingAddressParameter.init(billing_first_name: "Zach-test", billing_last_name: "Wigginton", billing_email: "742823994@qq.com", billing_phone: "+1 04695308545", billing_postal_code: "33333", billing_address: "wichita", billing_city: "wichita", billing_state: "KS", billing_country: "US", ip: "146.190.85.8")
