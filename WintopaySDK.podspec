#
#  Be sure to run `pod spec lint WintopaySDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source  = { :git => "https://github.com/win2pay/ios-sdk.git", :tag => "1.0.0" }
  ...
  # spec.public_header_files = "WintopaySDK/**/*.h"
  ...
  # spec.resource  = "Resources/Wintopay.bundle"
